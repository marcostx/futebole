...
- [ ] Glue the ball to its carrier until kicked.
- [ ] Add a per-player action cooldown; prevent shot power collapsing to zero.
- [ ] Resolve possession centrally with a proper tackle/contest (fix turn-order bug).
- [ ] Verify goal detection once the ball can actually reach the goal.

### Tier 2 — Positioning & AI realism
- [ ] Add circle-based player–player separation (no overlap).
- [ ] Implement role-based home positions and hold team shape.
- [ ] Only the pressing player chases the ball; others hold zones.
- [ ] Add goalkeeper behavior.
