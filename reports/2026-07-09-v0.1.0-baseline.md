...
### Tier 5 — Tactical realism (gaps observed vs. a commercial match sim)

Source: frame-by-frame study of an EA FC quick-sim match (Crystal Palace x
Arsenal, 2D top-down). The reference sim defends in organized blocks, keeps a
rest defense while attacking, transitions as a unit, and attacks with width
and coordinated runs — the areas below are where our simulation diverges most.

- [ ] Defensive block with lines ("two banks"): defenders and midfielders hold
...
- [ ] Rest defense: cap how many players push forward in attack; keep 1–2
