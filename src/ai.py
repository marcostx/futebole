...
class AIController:
    ...
    def update(self, dt):
        ...
        nearest_player = self.team.nearest_player_to_ball(self.ball)
        
        # If no active player, set the nearest player as active
    ...
    def execute_defense_behavior(self, dt):
        ...
        for player in self.team.players:
            if player != self.active_player:
                ...
                # Add some randomness to avoid players clustering
